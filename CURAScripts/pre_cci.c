# 1 "d:\\sdet training\\loadrunnerscripts\\curascripts\\\\combined_CURAScripts.c"
...
# 1 "d:\\sdet training\\loadrunnerscripts\\curascripts\\\\combined_CURAScripts.c" 2
...
# 2 "d:\\sdet training\\loadrunnerscripts\\curascripts\\\\combined_CURAScripts.c" 2
...
# 3 "d:\\sdet training\\loadrunnerscripts\\curascripts\\\\combined_CURAScripts.c" 2
...
# 4 "d:\\sdet training\\loadrunnerscripts\\curascripts\\\\combined_CURAScripts.c" 2
...
Action()
{
	...
	web_submit_form("appointment.php", 
		"Snapshot=t16.inf", 
		"ITEMDATA", 
		"Name=facility", "Value={hname}", "ENDITEM", 
		"Name=hospital_readmission", "Value={adm}", "ENDITEM", 
		"Name=programs", "Value={type}", "ENDITEM", 
		"Name=visit_date", "Value={date}", "ENDITEM", 
		"Name=comment", "Value={com}", "ENDITEM", 
		"LAST");
...
# 5 "d:\\sdet training\\loadrunnerscripts\\curascripts\\\\combined_CURAScripts.c" 2
...
# 6 "d:\\sdet training\\loadrunnerscripts\\curascripts\\\\combined_CURAScripts.c" 2
